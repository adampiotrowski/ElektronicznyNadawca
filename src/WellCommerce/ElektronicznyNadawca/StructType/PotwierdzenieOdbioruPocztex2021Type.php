...
class PotwierdzenieOdbioruPocztex2021Type extends AbstractStructBase
{
     ...
     * Set ilosc value
     * @param int $ilosc
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PotwierdzenieOdbioruPocztex2021Type
     */
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztex2021Enum::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztex2021Enum::getValidValues()
    ...
    public function setSposobPotwierdzeniaOdbioru(string $sposobPotwierdzeniaOdbioru): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztex2021Enum::valueIsValid($sposobPotwierdzeniaOdbioru)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztex2021Enum', is_array($sposobPotwierdzeniaOdbioru) ? implode(', ', $sposobPotwierdzeniaOdbioru) : var_export($sposobPotwierdzeniaOdbioru, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztex2021Enum::getValidValues())), __LINE__);
        }
