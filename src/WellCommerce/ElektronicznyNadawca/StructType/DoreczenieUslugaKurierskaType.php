...
class DoreczenieUslugaKurierskaType extends AbstractStructBase
{
     ...
     * @param string $oczekiwanyTerminDoreczenia
     * @return \WellCommerce\ElektronicznyNadawca\StructType\DoreczenieUslugaKurierskaType
     */
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaUslugiType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaUslugiType::getValidValues()
    ...
    public function setOczekiwanaGodzinaDoreczenia(?string $oczekiwanaGodzinaDoreczenia = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaUslugiType::valueIsValid($oczekiwanaGodzinaDoreczenia)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaUslugiType', is_array($oczekiwanaGodzinaDoreczenia) ? implode(', ', $oczekiwanaGodzinaDoreczenia) : var_export($oczekiwanaGodzinaDoreczenia, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaUslugiType::getValidValues())), __LINE__);
        }
