...
class PaletaType extends AbstractStructBase
{
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\RodzajPaletyType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\RodzajPaletyType::getValidValues()
    ...
    public function setRodzajPalety(?string $rodzajPalety = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\RodzajPaletyType::valueIsValid($rodzajPalety)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\RodzajPaletyType', is_array($rodzajPalety) ? implode(', ', $rodzajPalety) : var_export($rodzajPalety, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\RodzajPaletyType::getValidValues())), __LINE__);
        }
