...
class GetAddresLabelByGuidCompactResponse extends AbstractStructBase
{
     ...
     * @param string $pdfContent
     * @return \WellCommerce\ElektronicznyNadawca\StructType\GetAddresLabelByGuidCompactResponse
     */
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getAddresLabelByGuidCompactResponseErrorItem) {
            ...
            if (!$getAddresLabelByGuidCompactResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
