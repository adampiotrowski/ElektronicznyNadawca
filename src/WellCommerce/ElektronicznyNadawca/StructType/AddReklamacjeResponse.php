...
class AddReklamacjeResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $addReklamacjeResponseErrorItem) {
            ...
            if (!$addReklamacjeResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \WellCommerce\ElektronicznyNadawca\StructType\AddReklamacjeResponse
     */
    ...
    public static function validateReklamacjaInfoForArrayConstraintsFromSetReklamacjaInfo(?array $values = []): string
    {
        ...
        foreach ($values as $addReklamacjeResponseReklamacjaInfoItem) {
            // validation for constraint: itemType
            if (!$addReklamacjeResponseReklamacjaInfoItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ReklamacjaInfoType) {
