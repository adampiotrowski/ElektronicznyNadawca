...
class GetWplatyCKP extends AbstractStructBase
{
     ...
     */
    public function __construct(string $numerNadania, string $startDate, ?string $stopDate = null)
    {
        $this
     ...
     */
    public function validateNumerNadaniaForChoiceConstraintsFromSetNumerNadania($value): string
    {
        $message = '';
        if (is_null($value)) {
            return $message;
     ...
     * @param string $numerNadania
     * @return \WellCommerce\ElektronicznyNadawca\StructType\GetWplatyCKP
     */
