...
class PobranieType extends AbstractStructBase
{
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\SposobPobraniaType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\SposobPobraniaType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $sposobPobrania
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PobranieType
     */
    public function setSposobPobrania(?string $sposobPobrania = null): self
    {
        // validation for constraint: enumeration
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\SposobPobraniaType::valueIsValid($sposobPobrania)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\SposobPobraniaType', is_array($sposobPobrania) ? implode(', ', $sposobPobrania) : var_export($sposobPobrania, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\SposobPobraniaType::getValidValues())), __LINE__);
        }
