...
class PrzesylkaPoleconaKrajowaType extends PrzesylkaRejestrowanaType
{
     ...
     */
    public function __construct(string $kategoria, ?\WellCommerce\ElektronicznyNadawca\StructType\EPOType $epo = null, ?string $idLibraryForLegalDeposit = null, ?string $zasadySpecjalne = null, ?bool $posteRestante = false, ?int $iloscPotwierdzenOdbioru = 0, ?string $gabaryt = null, ?string $format = null, ?int $masa = null, ?bool $egzemplarzBiblioteczny = null, ?bool $dlaOciemnialych = null, ?bool $obszarMiasto = null, ?bool $miejscowa = null)
    {
        $this
     ...
     * @param string $kategoria
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPoleconaKrajowaType
     */
    ...
    /**
     * Set format value
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\FormatType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\FormatType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $format
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPoleconaKrajowaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\FormatType::valueIsValid($format)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\FormatType', is_array($format) ? implode(', ', $format) : var_export($format, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\FormatType::getValidValues())), __LINE__);
        }
        $this->format = $format;
