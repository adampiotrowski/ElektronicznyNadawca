...
class DoreczenieType extends AbstractStructBase
{
     ...
     * @param string $oczekiwanyTerminDoreczenia
     * @return \WellCommerce\ElektronicznyNadawca\StructType\DoreczenieType
     */
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaType::getValidValues()
    ...
    public function setOczekiwanaGodzinaDoreczenia(?string $oczekiwanaGodzinaDoreczenia = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaType::valueIsValid($oczekiwanaGodzinaDoreczenia)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaType', is_array($oczekiwanaGodzinaDoreczenia) ? implode(', ', $oczekiwanaGodzinaDoreczenia) : var_export($oczekiwanaGodzinaDoreczenia, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\OczekiwanaGodzinaDoreczeniaType::getValidValues())), __LINE__);
        }
