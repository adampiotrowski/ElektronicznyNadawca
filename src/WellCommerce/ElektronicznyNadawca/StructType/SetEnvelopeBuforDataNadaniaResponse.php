...
class SetEnvelopeBuforDataNadaniaResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $setEnvelopeBuforDataNadaniaResponseErrorItem) {
            ...
            if (!$setEnvelopeBuforDataNadaniaResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \WellCommerce\ElektronicznyNadawca\StructType\SetEnvelopeBuforDataNadaniaResponse
     */
