...
class GetOutboxBookResponse extends AbstractStructBase
{
     ...
     * @param string $pdfContent
     * @return \WellCommerce\ElektronicznyNadawca\StructType\GetOutboxBookResponse
     */
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getOutboxBookResponseErrorItem) {
            ...
            if (!$getOutboxBookResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
