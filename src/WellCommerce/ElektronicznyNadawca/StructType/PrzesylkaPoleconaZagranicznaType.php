...
class PrzesylkaPoleconaZagranicznaType extends PrzesylkaRejestrowanaType
{
     ...
     */
    public function __construct(?\WellCommerce\ElektronicznyNadawca\StructType\DeklaracjaCelna2Type $deklaracjaCelna2 = null, ?string $zawartosc = null, ?bool $posteRestante = false, ?int $masa = null, ?int $iloscPotwierdzenOdbioru = null)
    {
        $this
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\DeklaracjaCelna2Type $deklaracjaCelna2
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPoleconaZagranicznaType
     */
