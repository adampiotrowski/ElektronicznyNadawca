...
class ClearEnvelopeByGuidsResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $clearEnvelopeByGuidsResponseErrorItem) {
            ...
            if (!$clearEnvelopeByGuidsResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \WellCommerce\ElektronicznyNadawca\StructType\ClearEnvelopeByGuidsResponse
     */
