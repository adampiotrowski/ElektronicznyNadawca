...
class PrzesylkaListowaZadeklarowanaWartoscType extends PrzesylkaRejestrowanaType
{
     ...
     * @param int $masa
     */
    public function __construct(string $kategoria, string $gabaryt, ?bool $posteRestante = false, ?int $wartosc = null, ?int $iloscPotwierdzenOdbioru = 0, ?int $masa = null)
    {
        $this
     ...
     * @param string $kategoria
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaListowaZadeklarowanaWartoscType
     */
