...
class AddRozbieznoscDoZapowiedziFakturResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $addRozbieznoscDoZapowiedziFakturResponseErrorItem) {
            ...
            if (!$addRozbieznoscDoZapowiedziFakturResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \WellCommerce\ElektronicznyNadawca\StructType\AddRozbieznoscDoZapowiedziFakturResponse
     */
