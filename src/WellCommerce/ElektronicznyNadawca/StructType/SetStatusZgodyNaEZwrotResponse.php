...
class SetStatusZgodyNaEZwrotResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $setStatusZgodyNaEZwrotResponseErrorItem) {
            ...
            if (!$setStatusZgodyNaEZwrotResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \WellCommerce\ElektronicznyNadawca\StructType\SetStatusZgodyNaEZwrotResponse
     */
