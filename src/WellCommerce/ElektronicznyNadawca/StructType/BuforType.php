...
class BuforType extends AbstractStructBase
{
     ...
     */
    public function __construct(?\WellCommerce\ElektronicznyNadawca\StructType\ProfilType $profil = null, ?int $idKarta = null, ?int $idBufor = null, ?string $dataNadania = null, ?int $urzadNadania = null, ?bool $active = null, ?string $opis = null, ?bool $aktualizujPlanowanaDateNadaniaPrzesylek = null)
    {
        $this
            ->setProfil($profil)
            ->setIdKarta($idKarta)
