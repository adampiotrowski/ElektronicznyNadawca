...
class RelatedToAllegroType extends AbstractStructBase
{
     ...
     * Set id value
     * @param string $id
     * @return \WellCommerce\ElektronicznyNadawca\StructType\RelatedToAllegroType
     */
    ...
    /**
     * Set channel value
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\RelatedToAllegroChannelType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\RelatedToAllegroChannelType::getValidValues()
    ...
    public function setChannel(?string $channel = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\RelatedToAllegroChannelType::valueIsValid($channel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\RelatedToAllegroChannelType', is_array($channel) ? implode(', ', $channel) : var_export($channel, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\RelatedToAllegroChannelType::getValidValues())), __LINE__);
        }
