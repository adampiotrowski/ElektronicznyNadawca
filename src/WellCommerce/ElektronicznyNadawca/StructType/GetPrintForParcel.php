...
class GetPrintForParcel extends AbstractStructBase
{
     ...
     * - maxOccurs: 1
     * - minOccurs: 1
     * @var \WellCommerce\ElektronicznyNadawca\StructType\PrintType
     */
    protected \WellCommerce\ElektronicznyNadawca\StructType\PrintType $type;
    /**
     * Constructor method for getPrintForParcel
     * @uses GetPrintForParcel::setGuid()
     * @uses GetPrintForParcel::setType()
     * @param string[] $guid
     * @param \WellCommerce\ElektronicznyNadawca\StructType\PrintType $type
     */
    public function __construct(array $guid, \WellCommerce\ElektronicznyNadawca\StructType\PrintType $type)
    {
        $this
            ->setGuid($guid)
            ->setType($type);
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateGuidForLengthConstraintFromSetGuid($values): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getPrintForParcelGuidItem) {
     ...
     * @param string[] $guid
     * @return \WellCommerce\ElektronicznyNadawca\StructType\GetPrintForParcel
     */
     ...
     */
    public function getType(): \WellCommerce\ElektronicznyNadawca\StructType\PrintType
    {
        return $this->type;
    }
    /**
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\GetPrintForParcel
     */
    public function setType(\WellCommerce\ElektronicznyNadawca\StructType\PrintType $type): self
    {
        $this->type = $type;
