...
class UpdateEnvelopeBufor extends AbstractStructBase
{
    ...
    public static function validateBuforForArrayConstraintsFromSetBufor(?array $values = []): string
    {
        ...
        foreach ($values as $updateEnvelopeBuforBuforItem) {
            ...
            if (!$updateEnvelopeBuforBuforItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\BuforType) {
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\BuforType[] $bufor
     * @return \WellCommerce\ElektronicznyNadawca\StructType\UpdateEnvelopeBufor
     */
