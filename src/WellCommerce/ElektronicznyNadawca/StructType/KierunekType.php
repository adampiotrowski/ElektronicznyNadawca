...
class KierunekType extends AbstractStructBase
{
     ...
     */
    public static function validateKodPocztowyForArrayConstraintsFromSetKodPocztowy(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateKodPocztowyForMaxLengthConstraintFromSetKodPocztowy($values): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $kierunekTypeKodPocztowyItem) {
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateKodPocztowyForMinLengthConstraintFromSetKodPocztowy($values): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $kierunekTypeKodPocztowyItem) {
