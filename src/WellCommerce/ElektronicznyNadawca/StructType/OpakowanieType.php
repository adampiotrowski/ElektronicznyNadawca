...
class OpakowanieType extends AbstractStructBase
{
    ...
    /**
     * Set typ value
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\TypOpakowanieType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\TypOpakowanieType::getValidValues()
    ...
    public function setTyp(?string $typ = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\TypOpakowanieType::valueIsValid($typ)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\TypOpakowanieType', is_array($typ) ? implode(', ', $typ) : var_export($typ, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\TypOpakowanieType::getValidValues())), __LINE__);
        }
        $this->typ = $typ;
