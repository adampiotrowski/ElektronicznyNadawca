...
class GetZapowiedziFakturResponse extends AbstractStructBase
{
     ...
     */
    public static function validateZapowiedzFakturyZipFileForArrayConstraintsFromSetZapowiedzFakturyZipFile(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
     ...
     * @param string[] $zapowiedzFakturyZipFile
     * @return \WellCommerce\ElektronicznyNadawca\StructType\GetZapowiedziFakturResponse
     */
