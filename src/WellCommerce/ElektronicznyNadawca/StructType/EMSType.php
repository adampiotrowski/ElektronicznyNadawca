...
class EMSType extends PrzesylkaRejestrowanaType
{
     ...
     */
    public function __construct(?\WellCommerce\ElektronicznyNadawca\StructType\UbezpieczenieType $ubezpieczenie = null, ?\WellCommerce\ElektronicznyNadawca\StructType\DeklaracjaCelnaType $deklaracjaCelna = null, ?\WellCommerce\ElektronicznyNadawca\StructType\PotwierdzenieDoreczeniaType $potwierdzenieDoreczenia = null, ?\WellCommerce\ElektronicznyNadawca\StructType\DeklaracjaCelna2Type $deklaracjaCelna2 = null, ?string $sposobNadaniaInterconnect = null, ?\WellCommerce\ElektronicznyNadawca\StructType\SposobDoreczeniaType $sposobDoreczenia = null, ?string $typOpakowania = null, ?int $masa = null, ?bool $zalaczoneDokumenty = null, ?string $numerPrzesylkiKlienta = null)
    {
        $this
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\UbezpieczenieType $ubezpieczenie
     * @return \WellCommerce\ElektronicznyNadawca\StructType\EMSType
     */
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\EMSTypOpakowaniaType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\EMSTypOpakowaniaType::getValidValues()
    ...
    public function setTypOpakowania(?string $typOpakowania = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\EMSTypOpakowaniaType::valueIsValid($typOpakowania)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\EMSTypOpakowaniaType', is_array($typOpakowania) ? implode(', ', $typOpakowania) : var_export($typOpakowania, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\EMSTypOpakowaniaType::getValidValues())), __LINE__);
        }
