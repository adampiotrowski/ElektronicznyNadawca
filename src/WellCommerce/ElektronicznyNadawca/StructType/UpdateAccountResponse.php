...
class UpdateAccountResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $updateAccountResponseErrorItem) {
            ...
            if (!$updateAccountResponseErrorItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \WellCommerce\ElektronicznyNadawca\StructType\UpdateAccountResponse
     */
