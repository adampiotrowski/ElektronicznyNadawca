...
class WyslijLinkaOStatusieEZwrotu extends AbstractStructBase
{
     ...
     */
    public static function validateGuidZgodaEZwrotForArrayConstraintsFromSetGuidZgodaEZwrot(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateGuidZgodaEZwrotForLengthConstraintFromSetGuidZgodaEZwrot($values): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $wyslijLinkaOStatusieEZwrotuGuidZgodaEZwrotItem) {
     ...
     * @param string[] $guidZgodaEZwrot
     * @return \WellCommerce\ElektronicznyNadawca\StructType\WyslijLinkaOStatusieEZwrotu
     */
