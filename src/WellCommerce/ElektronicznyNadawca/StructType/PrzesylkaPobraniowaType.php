...
class PrzesylkaPobraniowaType extends PrzesylkaRejestrowanaType
{
     ...
     * @param int $masa
     */
    public function __construct(string $kategoria, string $gabaryt, int $wartosc, ?\WellCommerce\ElektronicznyNadawca\StructType\PobranieType $pobranie = null, ?bool $posteRestante = false, ?int $iloscPotwierdzenOdbioru = 0, ?bool $ostroznie = false, ?int $masa = null)
    {
        $this
     ...
     * @param string $kategoria
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPobraniowaType
     */
