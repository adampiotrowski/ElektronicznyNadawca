...
class PrzesylkaPaletowaType extends PrzesylkaRejestrowanaType
{
     ...
     */
    protected ?\WellCommerce\ElektronicznyNadawca\StructType\AdresType $miejsceOdbioru = null;
    /**
     ...
     * @var \WellCommerce\ElektronicznyNadawca\StructType\AdresType|null
     */
    protected ?\WellCommerce\ElektronicznyNadawca\StructType\AdresType $miejsceDoreczenia = null;
    /**
     * The platnik
     * Meta information extracted from the WSDL
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \WellCommerce\ElektronicznyNadawca\StructType\PlatnikType|null
     */
    protected ?\WellCommerce\ElektronicznyNadawca\StructType\PlatnikType $platnik = null;
    /**
     * The pobranie
     * Meta information extracted from the WSDL
     * - maxOccurs: 1
     ...
     * - maxOccurs: 32
     * - minOccurs: 0
     * @var \WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType[]
     */
     ...
     * - maxOccurs: 10
     * - minOccurs: 0
     * @var \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType[]
     */
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \WellCommerce\ElektronicznyNadawca\StructType\AwizacjaType|null
     */
    protected ?\WellCommerce\ElektronicznyNadawca\StructType\AwizacjaType $awizacja = null;
    /**
     * The zawartosc
     * @var string|null
     */
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\AdresType $miejsceDoreczenia
     * @param \WellCommerce\ElektronicznyNadawca\StructType\PlatnikType $platnik
     * @param \WellCommerce\ElektronicznyNadawca\StructType\PobranieType $pobranie
     * @param \WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType[] $subPaleta
     * @param \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType[] $daneSent
     * @param \WellCommerce\ElektronicznyNadawca\StructType\AwizacjaType $awizacja
     ...
     * @param bool $awizoSMS
     */
    public function __construct(\WellCommerce\ElektronicznyNadawca\StructType\PaletaType $paleta, ?\WellCommerce\ElektronicznyNadawca\StructType\AdresType $miejsceOdbioru = null, ?\WellCommerce\ElektronicznyNadawca\StructType\AdresType $miejsceDoreczenia = null, ?\WellCommerce\ElektronicznyNadawca\StructType\PlatnikType $platnik = null, ?\WellCommerce\ElektronicznyNadawca\StructType\PobranieType $pobranie = null, ?array $subPaleta = null, ?array $daneSent = null, ?\WellCommerce\ElektronicznyNadawca\StructType\AwizacjaType $awizacja = null, ?string $zawartosc = null, ?int $masa = null, ?string $dataZaladunku = null, ?string $dataDostawy = null, ?int $wartosc = null, ?int $iloscZwracanychPaletEUR = null, ?string $zalaczonaFV = null, ?string $zalaczonyWZ = null, ?string $zalaczoneInne = null, ?string $zwracanaFV = null, ?string $zwracanyWZ = null, ?string $zwracaneInne = null, ?string $powiadomienieNadawcy = null, ?string $powiadomienieOdbiorcy = null, ?bool $dostawaWSobote = null, ?bool $przygotowanieDokumentowPrzewozowych = null, ?bool $dostawaSamochodemDedykowanym = null, ?bool $zmianaDanychAdresowych = null, ?bool $ustalenieTerminuDostawy = null, ?bool $samochodZWinda = null, ?bool $zabranieOpakowania = null, ?bool $wniesienie = null, ?bool $awizoSMS = null)
    {
        $this
            ->setPaleta($paleta)
     ...
     * Set paleta value
     * @param \WellCommerce\ElektronicznyNadawca\StructType\PaletaType $paleta
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPaletowaType
     */
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPaletowaType
     */
    public function setMiejsceOdbioru(?\WellCommerce\ElektronicznyNadawca\StructType\AdresType $miejsceOdbioru = null): self
    {
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\AdresType|null
     */
    public function getMiejsceDoreczenia(): ?\WellCommerce\ElektronicznyNadawca\StructType\AdresType
    {
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPaletowaType
     */
    public function setMiejsceDoreczenia(?\WellCommerce\ElektronicznyNadawca\StructType\AdresType $miejsceDoreczenia = null): self
    {
    ...
    /**
     * Get platnik value
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PlatnikType|null
     */
    public function getPlatnik(): ?\WellCommerce\ElektronicznyNadawca\StructType\PlatnikType
    {
        return $this->platnik;
    }
    /**
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPaletowaType
     */
    public function setPlatnik(?\WellCommerce\ElektronicznyNadawca\StructType\PlatnikType $platnik = null): self
    {
     ...
     */
    public static function validateSubPaletaForArrayConstraintsFromSetSubPaleta(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
        ...
        foreach ($values as $przesylkaPaletowaTypeSubPaletaItem) {
            ...
            if (!$przesylkaPaletowaTypeSubPaletaItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The subPaleta property can only contain items of type \WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType $item
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPaletowaType
     */
    public function addToSubPaleta(\WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType) {
            throw new InvalidArgumentException(sprintf('The subPaleta property can only contain items of type \WellCommerce\ElektronicznyNadawca\StructType\SubPrzesylkaPaletowaType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(32)
    ...
    /**
     * Get daneSent value
     * @return \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType[]
     */
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateDaneSentForArrayConstraintsFromSetDaneSent(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
        ...
        foreach ($values as $przesylkaPaletowaTypeDaneSentItem) {
            // validation for constraint: itemType
            if (!$przesylkaPaletowaTypeDaneSentItem instanceof \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The daneSent property can only contain items of type \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType $item
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPaletowaType
     */
    public function addToDaneSent(\WellCommerce\ElektronicznyNadawca\StructType\DaneSentType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType) {
            throw new InvalidArgumentException(sprintf('The daneSent property can only contain items of type \WellCommerce\ElektronicznyNadawca\StructType\DaneSentType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(10)
    ...
    /**
     * Get awizacja value
     * @return \WellCommerce\ElektronicznyNadawca\StructType\AwizacjaType|null
     */
    public function getAwizacja(): ?\WellCommerce\ElektronicznyNadawca\StructType\AwizacjaType
    {
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaPaletowaType
     */
    public function setAwizacja(?\WellCommerce\ElektronicznyNadawca\StructType\AwizacjaType $awizacja = null): self
    {
    ...
    public function setPowiadomienieOdbiorcy(?string $powiadomienieOdbiorcy = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\ESposobPowiadomieniaType::valueIsValid($powiadomienieOdbiorcy)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\ESposobPowiadomieniaType', is_array($powiadomienieOdbiorcy) ? implode(', ', $powiadomienieOdbiorcy) : var_export($powiadomienieOdbiorcy, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\ESposobPowiadomieniaType::getValidValues())), __LINE__);
        }
