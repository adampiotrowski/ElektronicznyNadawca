...
class PrzesylkaZadeklarowanaWartoscZagranicznaType extends PrzesylkaRejestrowanaType
{
     ...
     * @param int $wartosc
     */
    public function __construct(?\WellCommerce\ElektronicznyNadawca\StructType\DeklaracjaCelna2Type $deklaracjaCelna2 = null, ?string $zawartosc = null, ?bool $posteRestante = false, ?int $masa = null, ?int $iloscPotwierdzenOdbioru = null, ?int $wartosc = null)
    {
        $this
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\DeklaracjaCelna2Type $deklaracjaCelna2
     * @return \WellCommerce\ElektronicznyNadawca\StructType\PrzesylkaZadeklarowanaWartoscZagranicznaType
     */
