...
class OczekujeNaZgodeEZwrotType extends AbstractStructBase
{
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType|null
     */
    protected ?\WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType $sklepEZwrot = null;
    /**
     * The idZgody
     * @var int|null
     */
     ...
     * @param \WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType $sklepEZwrot
     * @param int $idZgody
     ...
     */
    public function __construct(?\WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType $sklepEZwrot = null, ?int $idZgody = null, ?string $nazwaProduktu = null, ?string $numerZamowienia = null, ?string $numerNadania = null, ?string $email = null, ?string $dataNadania = null, ?string $guidZgodaEZwrot = null)
    {
        $this
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType|null
     */
    public function getSklepEZwrot(): ?\WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType
    {
     ...
     */
    public function setSklepEZwrot(?\WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType $sklepEZwrot = null): self
    {
