...
class AddRozbieznoscDoZapowiedziFaktur extends AbstractStructBase
{
     ...
     */
    public static function validateRozbieznosciZipFileForArrayConstraintsFromSetRozbieznosciZipFile(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
     ...
     * @param string[] $rozbieznosciZipFile
     * @return \WellCommerce\ElektronicznyNadawca\StructType\AddRozbieznoscDoZapowiedziFaktur
     */
