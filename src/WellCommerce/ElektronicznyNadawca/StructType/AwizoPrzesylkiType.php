...
class AwizoPrzesylkiType extends AbstractStructBase
{
     ...
     * @param string $dataPierwszegoAwizowania
     * @return \WellCommerce\ElektronicznyNadawca\StructType\AwizoPrzesylkiType
     */
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\MiejscaPozostawieniaAwizoEnum::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\MiejscaPozostawieniaAwizoEnum::getValidValues()
    ...
    public function setMiejscePozostawienia(?string $miejscePozostawienia = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\MiejscaPozostawieniaAwizoEnum::valueIsValid($miejscePozostawienia)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\MiejscaPozostawieniaAwizoEnum', is_array($miejscePozostawienia) ? implode(', ', $miejscePozostawienia) : var_export($miejscePozostawienia, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\MiejscaPozostawieniaAwizoEnum::getValidValues())), __LINE__);
        }
