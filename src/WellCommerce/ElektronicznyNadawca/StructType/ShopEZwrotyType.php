...
class ShopEZwrotyType extends AbstractStructBase
{
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \WellCommerce\ElektronicznyNadawca\StructType\EZwrotKartaType|null
     */
    protected ?\WellCommerce\ElektronicznyNadawca\StructType\EZwrotKartaType $eZwrotKarta = null;
    /**
     * The idShop
     * @var int|null
     */
     ...
     * @param string $mobile
     * @param string $email
     * @param \WellCommerce\ElektronicznyNadawca\StructType\EZwrotKartaType $eZwrotKarta
     * @param int $idShop
     * @param string $nazwa2
     ...
     */
    public static function validateEZwrotPrzesylkiForArrayConstraintsFromSetEZwrotPrzesylki(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
        ...
        foreach ($values as $shopEZwrotyTypeEZwrotPrzesylkiItem) {
            ...
            if (!\WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType::valueIsValid($shopEZwrotyTypeEZwrotPrzesylkiItem)) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType', is_array($invalidValues) ? implode(', ', $invalidValues) : var_export($invalidValues, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType::getValidValues()));
        }
        unset($invalidValues);
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType::getValidValues()
    ...
    {
        // validation for constraint: enumeration
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType::valueIsValid($item)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType', is_array($item) ? implode(', ', $item) : var_export($item, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotPrzesylkiType::getValidValues())), __LINE__);
        }
        // validation for constraint: maxOccurs(2)
    ...
    public function setMobile(string $mobile): self
    {
        ...
        if (!is_null($mobile) && mb_strlen((string) $mobile) > 20) {
            throw new InvalidArgumentException(sprintf('Invalid length of %s, the number of characters/octets contained by the literal must be less than or equal to 20', mb_strlen((string) $mobile)), __LINE__);
        }
        // validation for constraint: minLength(1)
        if (!is_null($mobile) && mb_strlen((string) $mobile) < 1) {
            throw new InvalidArgumentException(sprintf('Invalid length of %s, the number of characters/octets contained by the literal must be greater than or equal to 1', mb_strlen((string) $mobile)), __LINE__);
        }
        $this->mobile = $mobile;
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\EZwrotKartaType|null
     */
    public function getEZwrotKarta(): ?\WellCommerce\ElektronicznyNadawca\StructType\EZwrotKartaType
    {
     ...
     * @return \WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType
     */
    public function setEZwrotKarta(?\WellCommerce\ElektronicznyNadawca\StructType\EZwrotKartaType $eZwrotKarta = null): self
    {
    ...
    /**
     * Set eZwrotTyp value
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotTypZgodyType::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotTypZgodyType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $eZwrotTyp
     * @return \WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\EZwrotTypZgodyType::valueIsValid($eZwrotTyp)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotTypZgodyType', is_array($eZwrotTyp) ? implode(', ', $eZwrotTyp) : var_export($eZwrotTyp, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\EZwrotTypZgodyType::getValidValues())), __LINE__);
        }
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\WymagalnoscNumeruIdentyfikujacegoPrzesylkeEnum::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\WymagalnoscNumeruIdentyfikujacegoPrzesylkeEnum::getValidValues()
     * @throws InvalidArgumentException
     * @param string $wymagalnoscNumeruIdentyfikujacegoPrzesylke
     * @return \WellCommerce\ElektronicznyNadawca\StructType\ShopEZwrotyType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\WymagalnoscNumeruIdentyfikujacegoPrzesylkeEnum::valueIsValid($wymagalnoscNumeruIdentyfikujacegoPrzesylke)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\WymagalnoscNumeruIdentyfikujacegoPrzesylkeEnum', is_array($wymagalnoscNumeruIdentyfikujacegoPrzesylke) ? implode(', ', $wymagalnoscNumeruIdentyfikujacegoPrzesylke) : var_export($wymagalnoscNumeruIdentyfikujacegoPrzesylke, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\WymagalnoscNumeruIdentyfikujacegoPrzesylkeEnum::getValidValues())), __LINE__);
        }
