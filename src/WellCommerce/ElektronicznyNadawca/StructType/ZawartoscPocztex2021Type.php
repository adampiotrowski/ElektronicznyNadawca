...
class ZawartoscPocztex2021Type extends AbstractStructBase
{
    ...
    {
        return isset($this->zawartoscSpecjalna) ? $this->zawartoscSpecjalna : null;
    }
    /**
     * This method is responsible for validating the value passed to the setZawartoscSpecjalna method
     ...
     */
    public function validateZawartoscSpecjalnaForChoiceConstraintsFromSetZawartoscSpecjalna($value): string
    {
        $message = '';
        if (is_null($value)) {
            return $message;
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\ZawartoscSpecjalnaEnum::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\ZawartoscSpecjalnaEnum::getValidValues()
     * @throws InvalidArgumentException
     * @param string $zawartoscSpecjalna
     * @return \WellCommerce\ElektronicznyNadawca\StructType\ZawartoscPocztex2021Type
     */
    public function setZawartoscSpecjalna(?string $zawartoscSpecjalna = null): self
    {
        // validation for constraint: enumeration
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\ZawartoscSpecjalnaEnum::valueIsValid($zawartoscSpecjalna)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\ZawartoscSpecjalnaEnum', is_array($zawartoscSpecjalna) ? implode(', ', $zawartoscSpecjalna) : var_export($zawartoscSpecjalna, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\ZawartoscSpecjalnaEnum::getValidValues())), __LINE__);
        }
        // validation for constraint: choice(zawartoscSpecjalna, zawartoscInna)
        if ('' !== ($zawartoscSpecjalnaChoiceErrorMessage = self::validateZawartoscSpecjalnaForChoiceConstraintsFromSetZawartoscSpecjalna($zawartoscSpecjalna))) {
    ...
    {
        return isset($this->zawartoscInna) ? $this->zawartoscInna : null;
    }
    /**
     * This method is responsible for validating the value passed to the setZawartoscInna method
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public function validateZawartoscInnaForChoiceConstraintsFromSetZawartoscInna($value): string
    {
        $message = '';
        if (is_null($value)) {
            return $message;
    ...
    public function setZawartoscInna(?string $zawartoscInna = null): self
    {
        ...
        // validation for constraint: choice(zawartoscSpecjalna, zawartoscInna)
        if ('' !== ($zawartoscInnaChoiceErrorMessage = self::validateZawartoscInnaForChoiceConstraintsFromSetZawartoscInna($zawartoscInna))) {
