...
class DoreczeniePrzesylkiType extends AbstractStructBase
{
     ...
     * Set data value
     * @param string $data
     * @return \WellCommerce\ElektronicznyNadawca\StructType\DoreczeniePrzesylkiType
     */
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\PodmiotDoreczeniaEnum::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\PodmiotDoreczeniaEnum::getValidValues()
    ...
    public function setPodmiotDoreczenia(?string $podmiotDoreczenia = null): self
    {
        ...
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\PodmiotDoreczeniaEnum::valueIsValid($podmiotDoreczenia)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\PodmiotDoreczeniaEnum', is_array($podmiotDoreczenia) ? implode(', ', $podmiotDoreczenia) : var_export($podmiotDoreczenia, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\PodmiotDoreczeniaEnum::getValidValues())), __LINE__);
        }
     ...
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum::valueIsValid()
     * @uses \WellCommerce\ElektronicznyNadawca\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum::getValidValues()
     * @throws InvalidArgumentException
     * @param string $miejscePozostawieniaZawiadomieniaODoreczeniu
     * @return \WellCommerce\ElektronicznyNadawca\StructType\DoreczeniePrzesylkiType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\WellCommerce\ElektronicznyNadawca\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum::valueIsValid($miejscePozostawieniaZawiadomieniaODoreczeniu)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \WellCommerce\ElektronicznyNadawca\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum', is_array($miejscePozostawieniaZawiadomieniaODoreczeniu) ? implode(', ', $miejscePozostawieniaZawiadomieniaODoreczeniu) : var_export($miejscePozostawieniaZawiadomieniaODoreczeniu, true), implode(', ', \WellCommerce\ElektronicznyNadawca\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum::getValidValues())), __LINE__);
        }
